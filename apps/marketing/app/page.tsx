  ...
  <section className="bk-hero">
    ...
    <div className="bk-animate-fade-up">
      ...
      <div className="bk-hero-btns">
        <a href={getLoginUrl()} className="bk-btn-red" style={{ padding: "11px 22px", fontSize: 15 }}>
    ...
    <div style={{ maxWidth: 1280, margin: "0 auto" }}>
      <div className="bk-booking-section">
        ...
        <div className="bk-animate-fade-up">
          ...
          <a href={getLoginUrl()} className="bk-btn-red" style={{ marginTop: 28, padding: "12px 22px", fontSize: 14.5 }}>
    ...
    <div className="bk-cta-inner bk-animate-fade-up">
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 10, alignItems: "flex-start" }}>
        <div style={{ display: "flex", gap: 12, flexWrap: "wrap" }}>
          <a href={getLoginUrl()} className="bk-btn-outline" style={{ background: "#fff", color: T.red, border: "none", padding: "13px 24px", fontSize: 14.5, fontWeight: 700 }}>
